...
## Приложение собирает и хранит отзывы пользователей на произведения разных категорий, будь то книги или музыка,_ _фильмы или картины художников._
...
##### Тестовая база данных `db.sqlite3` находится [здесь](https://github.com/DNKer/piblic-notes/tree/main/).
